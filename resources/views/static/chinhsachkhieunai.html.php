...
<div class="main-content">
    <div class="container content-html-static">
        <div class="page-title">Chính sách giải quyết khiếu nại</div>
        <p><span>Thời gian khách hàng thực hiện khiếu nại đơn hàng:</span></p>
        ...
        <p><span>Vuaduoc.com sẽ ghi nhận tất cả những phản hồi của quý khách hàng nhanh nhất và nhân viên của chúng tôi sẽ liên hệ với quý khách hàng để đưa ra cách giải quyết phù hợp cho cả 2 bên!</span></p>
    </div>
</div>
<?php
