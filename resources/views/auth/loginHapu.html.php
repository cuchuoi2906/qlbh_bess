        ...
        <div class="login-page">
            <div class="row">
                ...
                <div class="col-xl-6 d-flex justify-content-center flex-column p-3 p-xl-5">
                    ...
                    <form action="<?= url('post.loginhapu') ?>" method="POST" class="form-login">
                        <div class="form-floating mb-2">
                            <input type="text" value="<?php echo $_COOKIE['userloginHapu']; ?>" name="username" class="form-control" id="floatingInput" placeholder="account" />
						...
						<div class="form-group password-input-control">
							<div class="input-group">
                                <input value="<?php echo isset($_COOKIE['passwordHapu']) ? base64_decode($_COOKIE['passwordHapu']) : ''; ?>" type="password" name="password" class="form-control" id="password" placeholder="Nhập mật khẩu">
								<div class="input-group-append">
									<span class="input-group-text" onclick="togglePassword()">
										<i class="fas fa-eye" id="toggleIcon"></i>
									</span>
