...
<div class="main-content">
    <div class="container content-html-static">
        <div class="page-title">Chính sách đặt hàng</div>

        <p><span style="font-size:14px;">Để đặt hàng tại website vuaduoc.com, hãy chắc chắn rằng quý khách đã ĐĂNG KÝ TÀI KHOẢN tại vuaduoc.com</span></p>
        ...
        <p><span style="font-size:14px;">"Flash sale / Thực Phẩm Chức Năng / Dược Mỹ Phẩm / Chăm Sóc Cá Nhân / Sản Phẩm Vua Dược / Thiết Bi Y Tế"</span></p>
        ...
        <p><span style="font-size:14px;"><strong>1.  Thanh toán bằng tiền mặt</strong></span></p>

        <p><span style="font-size:14px;">Thanh toán tiền mặt trực tiếp ngay khi Quý khách nhận hàng.</span></p>

        <p><span style="font-size:14px;">Vua dược sẽ giao hàng tới địa chỉ mà Quý khách đã yêu cầu trong đơn hàng và nhận thanh toán trực tiếp.</span></p>

        <p><span style="font-size:14px;"><strong>2. Thanh toán bằng chuyển khoản</strong></span></p>

        <p><span style="font-size:14px;">Để thanh toán đơn hàng bằng hình thức chuyển khoản, Quý khách vui lòng chuyển tiền vào tài khoản bên dưới hoặc tài khoản trong quá trình đặt hàng ( quét QR code ):</span></p>

        <p><span style="font-size:14px;">CÔNG TY CỔ PHẦN DỊCH VỤ THƯƠNG MẠI VÀ CÔNG NGHỆ DAK</span></p>

        <p><span style="font-size:14px;">Số tài khoản : 0851000024828</span></p>
