                ...
                <div class="main-header-2 align-items-center justify-content-between ga-3 d-xl-flex d-none">
                    ...
                    <div class="main-search-pc">
                        <div class="input-group rounded-pill">
                            ...
                            <input type="text" name="keyword" id="keyword" <?php echo $keyword; ?> class="form-control" placeholder="Bạn đang muốn tìm sản phẩm gì?" aria-label="basic-search" aria-describedby="basic-search">
                        </div>
                    </div>
                    <div class="cart">
                        <button type="button" class="position-relative">
                            ...
                            <span id="cartCount" class="position-absolute position-absolute top-0 end-0 badge rounded-pill bg-warning text-dark"> <?php echo intval($_SESSION['cart']); ?></span>
                        </button>
                    </div>
                    <?php 
                    if(checkLoginFe()){
                ...
                <div class="main-header-mb d-flex d-xl-none flex-column">
                    ...
                    <div class="main-search">
                        <div class="input-group">
                            ...
                            <input type="text" id="keywordm" name="keyword" value="<?php echo $keyword; ?>" class="form-control" placeholder="Bạn đang muốn tìm sản phẩm gì?" aria-label="basic-search" aria-describedby="basic-search">
                        </div>
                    </div>
                </div>
            </div>
