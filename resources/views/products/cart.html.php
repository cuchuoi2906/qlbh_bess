    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php 
                ...
                if(check_array($result['vars'])){
                    ?>
                    <div class="mb-2 content-box">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="form-check check-all">
                                <input class="form-check-input" type="checkbox" value="" checked id="check-all">
                                <label class="form-check-label" for="check-all"> Chọn tất cả </label><label class="form-check-label" id="checked-count">(<?php echo (count($result['vars'])-1).'/'.(count($result['vars'])-1); ?>)</label>
                            </div>
                    ...
                    <div class="content-box mb-3">
                        <div class="cart-item d-flex align-items-start justify-content-between">
                            <div class="left d-flex align-items-center gap-3">
                                <div>
                                    <input class="form-check-input" checked type="checkbox" value="<?php echo $product['id']; ?>" name="chk_product_cart[]" id="chk_product_cart[]">
                                </div>
                                <div class="thumb">
                                ...
                                <div class="info d-flex flex-column">
                                    ...
                                    ?>
                                        <span class="badge rounded-pill text-end mb-2" style="background-color: #FF6600;width: fit-content;"><?php echo $product['date']; ?></span>    
                                    <?php 
                                    }?>
                                    <div class="input-group number-input">
                                        ...
                                        <input type="number" id="productCount<?php echo intval($product['id']); ?>" <?php echo ($product['is_hot'] ? 'max="5"' : '');  ?> class="form-control inputNumber" value="<?php echo $quantity; ?>" min="0" />
                ...
                <?php 
                    ...
                    <div style="width: 100%;text-align: center;;">
                        <h6>Bạn chưa có sản phẩm nào trong giỏ hàng!</h6>
                        <p>Hãy thêm sản phẩm vào giỏ hảng của bạn nhé!</p>
                    </div>
                    <?php
                }?>
            </div>
                ...
                ?>
                    <div class="box-info mb-4">
                        <h2 class="info-title">
                            ...
                            <span class="float-end" onclick="onOffEditShip()" style="cursor: pointer;">
                                <span id="iconEditShip">
                                    <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_3803_1088)">
                                            <path d="M38.8526 24.3473C38.2735 24.3473 37.8042 24.8167 37.8042 25.3957V34.7048C37.8022 36.4408 36.3954 37.8479 34.659 37.85H5.24199C3.50558 37.8479 2.09885 36.4408 2.0968 34.7048V7.38457C2.09885 5.64816 3.50558 4.24142 5.24199 4.23938H14.5506C15.1297 4.23938 15.599 3.77005 15.599 3.19098C15.599 2.6119 15.1297 2.14258 14.5506 2.14258H5.24199C2.34825 2.14585 0.00327625 4.49083 0 7.38457V34.7048C0.00327625 37.5985 2.34825 39.9435 5.24199 39.9468H34.659C37.5527 39.9435 39.8977 37.5985 39.901 34.7048V25.3961C39.901 24.8171 39.4317 24.3473 38.8526 24.3473Z" fill="#247636"></path>
                                            <path d="M16.3936 18.8302L31.7014 3.52197L36.6383 8.45887L21.3304 23.7671L16.3936 18.8302Z" fill="#247636"></path>
                                            <path d="M13.8955 26.2649L19.3513 24.7537L15.4067 20.8091L13.8955 26.2649Z" fill="#247636"></path>
                                            <path d="M38.0031 0.927467C36.9789 -0.094312 35.3207 -0.094312 34.2964 0.927467L33.1846 2.03934L38.1215 6.97624L39.2333 5.86436C40.2555 4.84012 40.2555 3.18193 39.2333 2.1577L38.0031 0.927467Z" fill="#247636"></path>
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_3803_1088">
                                            <rect width="40" height="40" fill="white"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </span>    
                                <span id="iconUpdateShip" style="display:none;">
                                    <img src="<?= asset('/images/update-icon.png?2') ?>" width="25px">
                                </span>
                            </span>
                        </h2>
                        <ul class="d-flex flex-column list-style-none m-0 p-0 gap-2">
                            <li class="d-flex align-items-center gap-2">
                                ...
                                <span class="infoShipDefau"><?php echo $user->name; ?></span>
                                <span class="infoShipEdit" style="display:none;"><input class="form-control" name="ship_name" id="ship_name" value="<?php echo $user->name; ?>" /></span>
                            </li>
                            <li class="d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path
                                ...
                                <span class="text-dark"><?php echo $user->phone; ?>.</span>
                            </li>
                            <li class="d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path
                                ...
                                <span class="infoShipDefau"><?php echo $user->address_register; ?></span>
                                <span class="infoShipEdit" style="display:none;width: 100%;"><input class="form-control" name="ship_address" id="ship_address" value="<?php echo $user->address_register; ?>" /></span>
                            </li>
                        </ul>
                        <div class="mt-2">
...
<script>
    ...
    const productCheckboxes = document.querySelectorAll('input[name="chk_product_cart[]"]');

    // Lắng nghe sự kiện click vào checkbox "Chọn tất cả"
    checkAll.addEventListener("change", function () {
        const isChecked = checkAll.checked; // Trạng thái của checkbox "Chọn tất cả"
        productCheckboxes.forEach((checkbox) => {
            checkbox.checked = isChecked; // Gán trạng thái cho các checkbox sản phẩm
        });
        updateCheckedCount();
    });
    ...
    productCheckboxes.forEach((checkbox) => {
        checkbox.addEventListener("change", function () {
            // Nếu một checkbox sản phẩm không được chọn, bỏ chọn "Chọn tất cả"
            if (!this.checked) {
                checkAll.checked = false;
            } else {
                // Nếu tất cả checkbox sản phẩm đều được chọn, đánh dấu "Chọn tất cả"
    ...
    function updateCheckedCount() {
        ...
        const total = productCheckboxes.length; // Tổng số checkbox
        const checked = Array.from(productCheckboxes).filter((checkbox) => checkbox.checked).length; // Số checkbox được chọn
        checkedCountDisplay.textContent = `(${checked}/${total})`; // Cập nhật hiển thị
    }
</script>
<?php
