    ...
    <div class="container">
        <div class="checkout">
            <div class="checkout-content">
                <h3 class="checkout-title text-center">Nhập đúng số tài khoản để thanh toán đơn hàng</h3>
                ...
                <div class="row">
                    <!--<div class="col-md-5">
                        <img src="<?= asset('/images/qr-code-minh-duc.jpg') ?>" alt="qr-code" class="w-100">
                    ...
                    <div class="col-md-7">
                        <div class="d-flex flex-column mb-4 gap-2">
                            <div class="item">
                                ...
                                <div class="value fw-bold">TMCP ngoại thương Việt Nam</div>
                            </div>
                            <div class="item">
                                <label for="">Người nhận:</label>
                                <div class="value fw-bold">Công ty cổ phần dịch vụ thương mại và công nghệ DAK</div>
                            </div>
                            <div class="item">
                                <label for="">Số tài khoản:</label>
                                <div class="value fw-bold">0851000024828</div>
                            </div>
                            <div class="item">
								...
								<div class="value fw-bold">Họ Tên: <?php echo $orderData['ship_name']; ?>,Số điện thoại:<?php echo $orderData['ship_phone']; ?> , Địa chỉ nhận hàng:  <?php echo $orderData['note']; ?></div>
                            </div>
                        </div>
                        <!--<div class="box-info">
                        ...
                        <div class="btn-custom d-flex gap-2 align-items-center" id="btnOrderSuscess">
							...
							<a href="/" class="text-white">Mua tiếp đơn hàng mới</a>
						</div>
                    </div>
                </div>
            </div>
