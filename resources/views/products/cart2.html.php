    ...
    <div class="container">
        <div class="menu-prod">
            <div class="d-flex align-items-center gap-2">
				...
				<button class="active"><a href="/">TPCN NichieiAsia</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-8">
                        ...
                        <div class="cart-item d-flex align-items-start justify-content-between">
                            ...
                            <div class="right h-100">
                                <div class="cta d-flex justify-content-start flex-column text-end h-100 align-items-end h-100">
                                    ...
                                    <div class="close d-sm-none d-block btn-product-delete-m" data-product-id="<?php echo intval($product['id']); ?>">
            ...
            <div class="col-xl-4 mb-4">
				...
				<div class="content-box mb-4">
					<h2 class="content-title">Thông tin người mua hàng</h2>
					<div class="box-info">
						<h2 class="info-title">Họ tên</h2>
						<input type="text" value="" id="username" name="username" class="form-control" />
						
						<h2 class="info-title">Số điện thoại</h2>
						<input type="text" value="" id="phone" name="phone" class="form-control" />
						
						<h2 class="info-title">Địa chỉ nhận hàng</h2>
						<textarea
							class="form-control"
							id="exampleFormControlTextarea1"
							name="note"
							rows="3"
							placeholder="Ghi rõ địa chỉ nhận hàng và goi điện trước khi giao hàng"
						></textarea>
					</div>
				</div>
                <div class="content-box">
                    ...
                    <div class="form-check policy-check mt-2 mb-3">
                        ...
                        <label class="form-check-label" for="policy"> Tôi đồng ý với <a href="/chinh_sach_thanh_toan">Điều khoản sử dụng</a> </label>
                    </div>
                    <div class="btn-custom d-flex gap-2 align-items-center" id="btnOrder2">
