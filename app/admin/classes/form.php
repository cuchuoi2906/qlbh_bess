...
<div class="form-group" ' . $this->tr_html . '>
    ...
    */
    ...
    12.$add_text		: Chuỗi text thêm vào sau control(Exp: "(dd/mm/yyyy)")
    */
    function text($titleControl, $id, $name, $value, $title = '', $require = '0', $width = '', $height = '', $maxlength = '', $breakControl = ' - ', $add_html = '', $add_text = '', $type = 'text')
    {
        $arrID = explode($this->ec, $id);
        $arrName = explode($this->ec, $name);
        $arrValue = explode($this->ec, $value);
        ...
        for ($i = 0; $i < count($arrID); $i++) {
            if ($breakControl == "title") {
                $control .= $arrTitle[$i] . '&nbsp;';
                $control .= '<input class="' . $this->class_form_control . '" type="' . $type . '" placeholder="' . $arrTitle[$i] . '" id="' . $arrID[$i] . '" name="' . $arrName[$i] . '" value="' . $this->replaceQ($arrValue[$i]) . '" style="width:' . $arrWidth[$i] . 'px; height:' . $arrHeight[$i] . 'px" maxlength="' . $arrMaxlength[$i] . '" ' . $arrAdd_html[$i] . '/>';
                $control .= " &nbsp; ";
            } else {
                $control .= '<input class="' . $this->class_form_control . '" type="' . $type . '" placeholder="' . $arrTitle[$i] . '" id="' . $arrID[$i] . '" name="' . $arrName[$i] . '" value="' . $this->replaceQ($arrValue[$i]) . '" style="width:' . $arrWidth[$i] . 'px; height:' . $arrHeight[$i] . 'px" maxlength="' . $arrMaxlength[$i] . '" ' . $arrAdd_html[$i] . '/>';
    ...
    function number($titleControl, $id, $name, $value, $title = '', $require = '0', $width = '', $height = '', $maxlength = '', $breakControl = ' - ', $add_html = '', $add_text = '')
    {
        return $this->text($titleControl, $id, $name, $value, $title, $require, $width, $height, $maxlength, $breakControl, $add_html, $add_text, 'number');
    }
    ...
    */
    ...
    {
        $control = $wysiwyg;
        $control .= '<textarea placeholder="' . $title . '" class="' . $this->class_form_control . '" title="' . $title . '" id="' . $id . '" name="' . $name . '" style="width:' . $width . 'px; height:' . $height . 'px" ' . $add_html . '>' . $this->replaceQ($value) . '</textarea>';
        $control .= $add_text;
    ...
    */
    function wysiwyg($titleControl, $id, $value, $basePath = '../../resource/ckeditor/', $width = '100%', $height = '450')
    {
        ...
        $oFCKeditor->BasePath = '../../../resource/ckeditor/';
