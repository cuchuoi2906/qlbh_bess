            ...
            <div class="col-xs-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?= $form->wysiwyg("Mô tả", "trc_description", $trc_description ?? '', $editor_path); ?>
            ...
            <div class="col-xs-6">
                <div class="col-xs-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <?= $form->text("Ngày bắt đầu", "trc_start", "trc_start", $trc_start ?? date('d-m-Y'), "Ngày bắt đầu", 1, "", "", "", "", "", "") ?>
                                </div>
                                <div class="col-xs-6">
                                    <?= $form->text("Ngày kết thúc", "trc_end", "evt_end_time", $evt_end_time ?? '', "Để trống để chạy chiến dịch không kết thúc", 1, "", "", "", "", "", "") ?>
                                </div>
                            </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <?= $form->select("Sản phẩm (Để trống để chạy tất cả sản phẩm)", "pro_ids", "pro_id", $products ?? [], $pro_ids ?? [], "", 1, '', '', 1) ?>
