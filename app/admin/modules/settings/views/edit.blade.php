            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                            ...
                            <div class="tab-content">
                                @foreach($locales as $code => $locale)
                                    <div class="tab-pane {{$code=='vn'?'active':''}}" id="tab_content_{{$code}}">
                                        ...
                                        <div id="swe_value_plain_text_bound_{{$code}}">
                                            <?= $form->textarea("", 'swe_value_plain_text_' . $code, 'swe_value_plain_text_' . $code, ${'swe_value_' . $code})?>
                                        </div>
                                        <div id="swe_value_number_bound_{{$code}}">
                                            <?= $form->text("", 'swe_value_number_' . $code, 'swe_value_number_' . $code, ${'swe_value_' . $code})?>
                                        </div>
                                        <div id="swe_value_text_bound_{{$code}}">
                                            <?= $form->wysiwyg("", "swe_value_text_" . $code, html_entity_decode(${'swe_value_' . $code}), $editor_path, "", 1); ?>
                                        </div>
                        ...
                        ?>
                        <div class="gallery">
                            <img src="<?= url() . '/upload/settings/' . $value;?>"/>
                        </div>
                        <?php endforeach;?>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        $('#swe_type').change(function () {
            ...
            var type = $(this).val();
            if (type == 'text') {
                $('#swe_value_text_bound_vn').show();
                $('#swe_value_text_bound_en').show();
                $('#swe_value_plain_text_bound_vn').hide();
                $('#swe_value_plain_text_bound_en').hide();
                $('#swe_value_number_bound_vn').hide();
                $('#swe_value_number_bound_en').hide();
                $('#swe_value_image_bound').hide();
                $('.gallery').hide();
            } else if (type == 'image') {
                $('#swe_value_text_bound_vn').hide();
                $('#swe_value_text_bound_en').hide();
                $('#swe_value_plain_text_bound_vn').hide();
                $('#swe_value_plain_text_bound_en').hide();
                $('#swe_value_number_bound_vn').hide();
                $('#swe_value_number_bound_en').hide();
                ...
                $('#swe_value_text_bound_vn').hide();
                $('#swe_value_text_bound_en').hide();
                $('#swe_value_plain_text_bound_vn').show();
                $('#swe_value_plain_text_bound_en').show();
                $('#swe_value_number_bound_vn').hide();
                $('#swe_value_number_bound_en').hide();
                $('#swe_value_image_bound').hide();
                $('.gallery').hide();
                ...
                $('#swe_value_plain_text_bound_vn').hide();
                $('#swe_value_plain_text_bound_en').hide();
                $('#swe_value_number_bound_vn').show();
                $('#swe_value_number_bound_en').show();
                $('#swe_value_image_bound').hide();
                $('.gallery').hide();
            }
        });
