...
@section('content')
    <div class="container-fluid">
        <?php
        $form = new form();
        $form->create_form("edit_warehouse_export", $fs_action, "post", "application/x-www-form-urlencoded");
        ?>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?= $form->text("Số lượng khả dụng", "sae_quantity_kha_dung", "sae_quantity_kha_dung", $sae_quantity_kha_dung ?? 0, "0", 0) ?>
