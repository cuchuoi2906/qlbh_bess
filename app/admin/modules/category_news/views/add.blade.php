        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?= $form->select("Danh mục cha tin tức", "cat_parent_id", "cat_parent_id", $parent_options, $cat_parent_id, '', 0, "", 255, "", "", "") ?>
<!--                        --><?//= $form->select("Loại danh mục", "cat_type", "cat_type", $types, $type, '', 0, "", 255, 0, "", "") ?>
                            ...
                            <div class="tab-content">
                                @foreach($locales as $code => $locale)
                                    <div class="tab-pane {{$code=='vn'?'active':''}}" id="tab_{{$code}}">
                                        <?= $form->text("Tên danh mục tin tức", "cat_name_" . $code, "cat_name_" . $code, ${'cat_name_' . $code}, "Tên danh mục tin tức", 1, "", "", 255, "", "", "") ?>
