            ...
            <div class="col-xs-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <?= $form->text("Ngày bắt đầu", "evt_start_time", "evt_start_time", $evt_start_time ?? date('d-m-Y'), "Ngày bắt đầu", 1, "", "", "", "", "", "") ?>
                            </div>
                            <div class="col-xs-6">
                                <?= $form->text("Ngày kết thúc", "evt_end_time", "evt_end_time", $evt_end_time ?? date('d-m-Y'), "Ngày kết thúc", 1, "", "", "", "", "", "") ?>
                            </div>
                        </div>
