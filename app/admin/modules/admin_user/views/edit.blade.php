...
@section('content')
    <div class="container-fluid">
        <?php
        $form = new form();
        $form->create_form("edit", '', "post", "multipart/form-data", 'onsubmit="validateForm(); return false;"');
        ?>
        <?php
        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?= $form->text("Login name", "adm_loginname", "adm_loginname", $adm_loginname, "Login name", 1, "", "", 255, "", "disabled", "") ?>
