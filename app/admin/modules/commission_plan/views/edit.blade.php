        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?= $form->text("Tên", "cpl_plan_name", "cpl_plan_name", $cpl_plan_name ?? '', "Tên chính sách", 1, "", "", 255, "", "", "") ?>
                        <?= $form->text("Phần trăm hoa hồng", "cpl_commission_percent", "cpl_commission_percent", $cpl_commission_percent ?? 0, "% hoa hồng trực tiếp", 1, "", "", 255, "", "", "") ?>
                    </div>
                </div>
            </div>
...
@section('script')
    <script>
        ...
        load_district_ajax(<?= $agc_city_id ?>, <?=$agc_district_id?>);
        ...
        function load_district_ajax(city_id, district_id = null) {
            $.ajax({
                type: 'POST',
