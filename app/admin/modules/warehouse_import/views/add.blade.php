...
@section('content')
    <div class="container-fluid">
        <?php
        $form = new form();
        $form->create_form("add_warehouse_import", $fs_action, "post", "application/x-www-form-urlencoded");
        ?>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        {{-- Tên sản phẩm ẩn, tự điền theo select --}}
                        <?= $form->hidden("who_product_name", "who_product_name", $who_product_name ?? '') ?>

                        {{-- Ngày nhập — daterangepicker single --}}
                        <div class="form-group">
                            <label>Ngày nhập <span class="text-danger">*</span></label>
                                <input type="text" name="who_import_date" id="who_import_date"
                                       ...
                                       value="{{ $who_import_date_display ?? date('d/m/Y') }}"
        ...
        <div class="row">
            <div class="col-xs-12" style="text-align: center; margin-bottom: 20px;">
                <?= $form->button("submit" . $form->ec . "reset", "submit" . $form->ec . "reset", "submit" . $form->ec . "reset", "Lưu phiếu nhập" . $form->ec . "Làm lại", "Lưu phiếu nhập" . $form->ec . "Làm lại", "") ?>
...
@section('script')
    ...
    <script>
        ...
        // Điền tên sản phẩm vào hidden field khi chọn
